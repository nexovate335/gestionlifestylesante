...
from .models import FactureCaisseGarde, FactureAvanceGarde, CaisseGarde, AutresDepensesGarde, RapportJournalierCaisseGarde
import csv
...
@admin.register(FactureCaisseGarde)
class FactureCaisseGardeAdmin(BaseAdmin):
    list_display = ('patient', 'save_by', 'facture_date_time', 'total', 'total_somme_verse',
...
@admin.register(FactureAvanceGarde)
class FactureAvanceGardeAdmin(BaseAdmin):
...
@admin.register(CaisseGarde)
class CaisseGardeAdmin(BaseAdmin):
...
@admin.register(AutresDepensesGarde)
class AutresDepensesGardeAdmin(BaseAdmin):
...
@admin.register(RapportJournalierCaisseGarde)
class RapportJournalierCaisseGardeAdmin(BaseAdmin):

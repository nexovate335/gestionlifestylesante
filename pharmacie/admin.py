...
from .models import Produit, Fournisseur, Commande, Stock, Vente, FacturePharmacie, FactureAvance
import csv
...
class FournisseurAdmin(BaseAdmin):
    list_display = ('nom_fournisseur', 'ville', 'telephone')
    search_fields = ('nom_fournisseur', 'ville')
...
class VenteAdmin(BaseAdmin):
    list_display = ('num_vente', 'produit', 'quantite_vendue', 'prix_unitaire', 'prix_total', 'date_vente')
...
class FacturePharmacieAdmin(BaseAdmin):
    list_display = ('patient', 'facture_date_time', 'total', 'total_somme_verse', 'avance', 'reste_a_payer', 'nombre_versements', 'paye', 'deleted_at')
